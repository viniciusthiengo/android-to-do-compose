...
fun ExistingTaskAppBarActions(
    ...
    DisplayAlertDialog(
        title = stringResource(id = R.string.delete_task_template, selectedTask.title),
        message = stringResource(
            id = R.string.delete_task_confirmation_template,
            selectedTask.title
        ),
...
fun ExistingTaskAppBarPreview() {
    ExistingTaskAppBar(
        selectedTask = ToDoTask(
            id = 1,
            title = "Vinícius Thiengo YouTube channel",
            description = "Just a full YouTube channel description.",
